        ...
        <div class="flex flex-col lg:flex-row lg:space-x-8">
            ...
            <div class="w-full lg:w-3/4">
                <div class="bg-white  shadow-md mb-6">
                    <div class="p-6">
                        <h3 class="flex justify-center text-2xl font-semibold mb-4">My Profile</h3>
                        <div class="mb-4">
                            <label class="block text-gray-700 mb-2">Name*</label>
                            <input type="text"  name="name"  id="name"  placeholder="Enter Name" class="w-full border border-gray-300  p-3 focus:outline-none focus:border-blue-500"  value="{{ $user->name }}">
                        </div>
                        <div class="mb-4">
                            <label class="block text-gray-700 mb-2">Email*</label>
                            <input type="text"  name="email"  id="email"   placeholder="Enter Email" class="w-full border border-gray-300  p-3 focus:outline-none focus:border-blue-500"  value="{{ $user->email }}" >
                        </div>
                        <div class="mb-4">
                            <label class="block text-gray-700 mb-2">Designation*</label>
                            <input type="text" name="designation"  id="designation"   placeholder="Designation" class="w-full border border-gray-300  p-3 focus:outline-none focus:border-blue-500"   value="{{ $user->designation }}" >
                        </div>
                        <div class="mb-4">
                            <label class="block text-gray-700 mb-2">Mobile*</label>
                            <input type="text"   name="mobile"  id="mobile"  placeholder="Mobile" class="w-full border border-gray-300  p-3 focus:outline-none focus:border-blue-500" value="{{ $user->mobile }}">
                        </div>
                    </div>
                    <div class="p-6 bg-gray-50 flex justify-center">
                        <button type="button" class="flex justify-center items-center bg-gray-900 text-white py-2 px-4">
                            Update
                        </button>
                    </div>
                </div>
